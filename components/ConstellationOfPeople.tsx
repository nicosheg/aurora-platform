...
export default function ConstellationOfPeople({ people, voices, onNext }: { people: any[]; voices: any[]; onNext: () => void }) {
  ...
  return (
    <motion.section
      <CelebrationOverlay /> initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="min-h-screen flex flex-col items-center justify-center px-4 py-20 text-center bg-black">
