...
export default function FinalLetter({ title, paragraphs, senderName, onNext, onBack }: { title: string; paragraphs: string[]; senderName: string; onNext: () => void; onBack: () => void }) {
  return (
